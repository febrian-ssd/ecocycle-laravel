...
<head>
    ...
    <style>
        ...
        .content-area.blurred, .header.blurred { filter: blur(5px); } /* Efek blur untuk background & header */
        .popup-container {
            background: #004d00;
        ...
        .popup-container .form-control { background-color: #f0f0f0; border: none; border-radius: 10px; padding: 15px 15px 15px 45px; width: 100%; box-sizing: border-box; }
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Tombol untuk bertukar popup
            const showRegisterLink = document.getElementById('show-register-link');
            const showLoginLink = document.getElementById('show-login-link');

            // Semua tombol close (X)
